...
def get_args():
    ...
    # parser.add_argument("-d_templ_1d", required=False, default=None, type=int, help="1d template dims")
    # parser.add_argument("-d_templ_2d", required=False, default=None, type=int, help="2d template dims")
    ...
    def __init__(self, args):
        ...
        self.model = RoseTTAFoldModule(
            **MODEL_PARAM,
            ...
            d_templ_1d=90,
            d_templ_2d=72,
            # d_templ_1d=args.d_templ_1d.to(self.device),
            # d_templ_2d=args.d_templ_2d.to(self.device),
            # fit=args.symm_fit,
