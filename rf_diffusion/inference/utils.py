...
def parse_pdb_lines(lines, parse_hetatom=False, ignore_het_h=True,
    ...
    seq = [util.aa2num[r[2]] if r[2] in rf2aa.chemical.aa2num.keys() else 20 for r in res]
    chains = []
...
def get_repeat_t2d_mask(L, con_hal_idx0, contig_map, ij_is_visible, nrepeat, supplied_full_contig=True, repeat_mode=False):
    """
...
def parse_ij_get_repeat_mask(ij_visible, L, n_repeat, con_hal_idx0, supplied_full_contig, full_complex_idx0, contig_map, repeat_mode=False):
    """
    ...
    mask_t2d, _ = get_repeat_t2d_mask(L, con_hal_idx0, contig_map, ij_visible_int, n_repeat, supplied_full_contig=supplied_full_contig, repeat_mode=repeat_mode)
