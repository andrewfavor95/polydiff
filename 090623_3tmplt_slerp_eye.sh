...
wandb_pref='3tmpl_mfape10_slerp_crd0.5_III'
so3_type='slerp'
...
#ckpt_load_path='/home/davidcj/from/rohith/models/rf2a_25c_414.pt' ## standard ckpt 
#ckpt_load_path='/mnt/home/davidcj/from/rohith/models/rf2a_25c_414_t1d_81_t2d_68.pt'  # expanded t1d features 
...
srun /software/containers/SE3nv.sif -u train_multi_deep.py -p_drop 0.15 \
    ...
    -str_self_cond \
    -dataset pdb_aa,sm_complex \
    -dataset_prob 1.0,0.0 \
    ...
    -w_motif_disp 0 \
    -data_pkl_aa dataset_diffusion_20230214.pkl \
    -metric atom_bonds \
    -n_extra_block 4 \
    -n_main_block 32 \
    -n_ref_block 4 \
